...
def compute_advantage(
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        # Extract token-level log probs from rollout if available (for IPW baseline)
        token_level_log_probs = data.batch.get("rollout_log_probs", None)
        if token_level_log_probs is None:
            token_level_log_probs = data.batch.get("old_log_probs", None)
        ...
        advantages, returns = core_algos.compute_grpo_outcome_advantage(
            ...
            token_level_log_probs=token_level_log_probs,
        )
        data.batch["advantages"] = advantages
        data.batch["returns"] = returns
        ...
        # Extract token-level log probs from rollout if available
        token_level_log_probs = data.batch.get("rollout_log_probs", None)
