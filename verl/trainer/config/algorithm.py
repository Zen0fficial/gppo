...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        adv_estimator (str): Advantage estimator type: "gae", "grpo", "reinforce_plus_plus", "gppo", etc.
        norm_adv_by_std_in_grpo (bool): Whether to normalize advantages by std (specific to GRPO).
        value_loss_type (str): Type of value loss: "mse" (clipped MSE, default), "bce" (binary cross-entropy).
            BCE loss is recommended for G-PPO with binary outcome rewards (0/1).
    ...
    # IPW (Inverse Probability Weighted) baseline for GRPO
    # If True, uses normalized inverse probability weights for baseline calculation
    use_ipw: bool = False
